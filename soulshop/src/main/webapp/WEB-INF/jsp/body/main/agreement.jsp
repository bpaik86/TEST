...
<script>
	...
	function goMemberAuth() {
		if(!document.getElementById("mcssnY").checked){
			alert("약관동의 동의하지 않을 경우  회원가입이 불가능 합니다.");
			return;
		}		
		if(!document.getElementById("mcssn2Y").checked){
			alert("개인정보취급방침에 동의하지 않을 경우  회원가입이 불가능 합니다.");
			return;
		}		
	...
	function cancel(){
		document.frmMain.action="join_form.soul";
		document.frmMain.submit();
	}
	

</script>
<form name="frmMain"  id="frmMain" method="post"  action="join_form.soul">
	<input type="hidden" id="AGREEYN" name="AGREEYN" value="Y"/>
</form>
</head>
<body>
<p>&nbsp;</p>
...
<div align="center">
	<img src="/images/member/step1.JPG" alt="약관동의"/><br><br><br>
</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<div align="left" style="margin-left:12%; font-size:12pt;">  
	<b>이용 약관</b><br/><br/>
</div>

<div align="center">
<textarea rows="15" cols="120%" readonly>
제 1조 (목적)
이 약관은 부건에프엔씨㈜(이하 "회사"라 한다)이 운영하는 인터넷 쇼핑몰 (SOULSHOP) 이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 쇼핑몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
...
제 15조 (청약철회 등)
01.쇼핑몰과 재화등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다.
...
부 칙(시행일) 이 약관은 2012 년 10 월 13 일부터 시행합니다.부 칙(시행일) 이 약관은 2015년 07월 01일부터 시행하며 종전의 약관은 이 약관으로 대체 합니다.부 칙(시행일) 이 약관은 2015년 08월 21일부터 시행하며 종전의 약관은 이 약관으로 대체 합니다.
</textarea>
</div>
<br/>
<div align="right" style="margin-right:12%;">

	<input name=mcssnY type="radio" id="mcssnY" /><font size="2">동의함</font>
	<input name=mcssnY type="radio" id="mcssnN" value="N" checked="checked"/><font size="2">동의하지 않음</font>
...
ο 본 방침은  :  2005 년 02 월 01 일 부터 시행됩니다.

■ 수집하는 개인정보 항목

회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.

ο 수집항목 : 이름 , 생년월일 , 성별 , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일기념일 , 법정대리인정보 , 주민등록번호 , 신용카드 정보 , 은행계좌 정보 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보 , 결제기록
ο 개인정보 수집방법 : 서면양식 , 전화/팩스를 통한 회원가입 , 경품 행사 응모 , 배송 요청 , 제휴사로부터의 제공 , 생성정보 수집 툴을 통한 수집
...
원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
 ...
 보존 항목 : 이름 , 생년월일 , 성별 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일
...
또한 위탁계약 시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련법규의 준수, 개인정보에 관한 제3자 공급 금지, 사고시의 책임부담 등을 명확히 규정하고 있습니다. 동 업체가 변경될 경우, 변경된 업체 명을 공지사항 내지 개인정보취급방침 화면을 통해 고지 하겠습니다.


수탁자 수탁범위 
(주)나눔앤해피 [고객상담업무 위탁 운영] 
우체국택배 [주문 상품 배송] 
위사 [호스팅 시스템 구축 및 유지] 
LG U+ [결제 및 에스크로 서비스] 
...
이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다. 이용자 혹은 만 14세 미만 아동의 개인정보 조회?수정을 위해서는 ‘개인정보변경’(또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 “회원탈퇴”를 클릭 하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다. 귀하가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를 제3자 에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체없이 통지하여 정정이이루어지도록 하겠습니다 SOULSHOP은 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 “SOULSHOP가 수집하는 개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.

■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항

회사는 귀하의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등을 운용합니다. 쿠키란 SOULSHOP의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사은(는) 다음과 같은 목적을 위해 쿠키를 사용합니다.
...
<div align="right" style="margin-right:12%;"><br>
	<input name=mcssn2Y type="radio" id="mcssn2Y" /><font size="2">동의함</font>
	<input name=mcssn2Y type="radio" id="mcssn2N" value="N" checked="checked" /><font size="2">동의하지 않음</font>
</div>	


<div align="right"style="margin-right:12%;"><br><br>
	<input type="image" src="/images/member/ok.gif" onclick="goMemberAuth()" value="확인" />
	<a href="main.soul"><img src="/images/member/no.gif" alt="취소"/></a>
</div>
</table>
</body>
</html>