...
<tr>
	<td align="center"width="370" height="200"  bgcolor="f3f3f3">
		<font size=3 color=64C9BE><strong>${member.shop_mem_name}</strong></font><font size=2> 님의 비밀번호는 </font> <font size=3 color=0066cc><strong>${member.shop_mem_pw}</strong></font><font size=2> 입니다.</font>
	</td>
</tr>
</table>
<br>
