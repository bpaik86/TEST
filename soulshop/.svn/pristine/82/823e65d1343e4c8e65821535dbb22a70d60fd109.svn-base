...
<body>
	<form id="frm">
		<table class="board_view" align="center">
			...
			<tbody>
				<tr>
					<th scope="row">제목</th>
					<td><input type="text" id="FB_TITLE" name="FB_TITLE" class="wdp_90"></input></td>
				</tr>
				<tr>
					<th scope="">임시ID</th>
				...
				<tr>
					<th scope="">종류</th>
					<td><input type="text" id="FB_BOARD_TP" name="FB_BOARD_TP" class="view_text"></input></td>
				</tr>
				<tr>
					<td colspan="2" class="view_text">
						<textarea rows="20" cols="100" title="내용" id="FB_CONTENT" name="FB_CONTENT"></textarea>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<script type="text/javascript">
		...
		function fn_insertBoard(){
			...
			comSubmit.setUrl("<c:url value='/insertBoard2.soul' />");
			comSubmit.submit();
		}
	</script>
</body>
