...
function windowclose(){
	opener.document.joinform.shop_mem_id.value="${shop_mem_id}";
...
<c:when test="${chkId eq 1}">
	...
	<table width=400 border=0 cellspacing=0 cellpadding=5>
		<tr align=center>
			<td height=30>
				<font size=2><b>${shop_mem_id}</b> 은(는) 이미 사용 중인 아이디입니다</font>
			</td>
		</tr>
	</table>
	<table width=400 border=0 cellpadding=0 cellspacing=0>
		<tr>
			<td align=center>
				...
				<input type=text size=10 maxlength=12 name=shop_mem_id />
...
<c:otherwise>
	<table width=400 border=0 cellspacing=0 cellpadding=5>
		<tr>
			<td align=center>
				<br><br>
				<font size=2>입력하신 <b>${shop_mem_id}</b> 은(는) 사용할 수 있는 아이디입니다.</font>
				<br/><br/>
